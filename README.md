...
```kotlin
dependencies {
    implementation("dev.catbit:kroute:1.0.4")
    implementation("dev.catbit:kroute-google-cloud-extension:1.0.4") // optional
}
```
...
dependencies {
    implementation("dev.catbit:kroute:1.0.4")
    implementation("dev.catbit:kroute-google-cloud-extension:1.0.4")
}
```
